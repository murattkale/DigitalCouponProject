...
var KTDualListbox = {
    init: function () {
        $(".kt-dual-listbox").each(function () {
            var t = $(this),
                a = null != t.attr("data-available-title") ? t.attr("data-available-title") : "Departman List",
                e = null != t.attr("data-selected-title") ? t.attr("data-selected-title") : "Eklenen Departman List",
